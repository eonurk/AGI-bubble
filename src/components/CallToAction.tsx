			...
			<div className="container max-w-4xl mx-auto px-4 relative z-10 text-center space-y-8">
				...
				>
					...
					<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
						Your prediction adds signal to the noise. Join hundreds of others in
						defining the future of AGI.
					</p>
				</motion.div>
				...
				>
					<Button
						...
						className="h-14 px-8 text-lg rounded-full shadow-xl shadow-primary/20 hover:shadow-primary/40 hover:scale-105 transition-all bg-gradient-to-r from-primary to-cyan-600 border-0"
					>
